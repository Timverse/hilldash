...
export function CustomerFooter() {
  return (
    <footer className="bg-slate-900 text-slate-300 py-16 mt-20 font-sans antialiased">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          <div className="space-y-6">
            ...
            <p className="text-slate-400 text-sm leading-relaxed max-w-xs">
              Sawaïom — Rooted in Meghalaya. Premier quick-commerce and grocery delivery platform bringing fresh essentials to your doorstep in minutes.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-4 text-sm font-medium">
              ...
              <li><Link href="/about" className="hover:text-primary transition-colors">About Sawaïom</Link></li>
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-4 text-sm">
              <div className="flex gap-3">
                ...
                <span>Mookyrdup, Jowai, Meghalaya - 793150</span>
              </div>
              <div className="flex gap-3">
                <Phone className="w-5 h-5 text-primary shrink-0" />
                <span>+91 8974319494</span>
              </div>
              <div className="flex gap-3">
                <Mail className="w-5 h-5 text-primary shrink-0" />
                <span>hilldashmeg@gmail.com</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="pt-8 border-t border-slate-800 flex flex-col md:flex-row justify-between items-center gap-4 text-xs font-medium uppercase tracking-wider text-slate-500">
          <p>&copy; {new Date().getFullYear()} Sawaïom Services Pvt. Ltd.</p>
