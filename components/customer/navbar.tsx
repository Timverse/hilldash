...
export function CustomerNavbar() {
  ...
  return (
    <nav className={`sticky top-0 z-50 w-full transition-all duration-300 font-sans antialiased ${isScrolled ? "bg-white/80 backdrop-blur-lg border-b shadow-sm py-2" : "bg-white py-4"
      }`}>
